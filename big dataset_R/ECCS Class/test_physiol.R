...
df <- data.frame(x,y,ECCS_Class)
df$ECCS_Class <- ifelse(df$ECCS_Class=="",NA,df$ECCS_Class)
df$y <- ifelse(df$y==0,NA,df$y)
df$x <- ifelse(df$x==0,NA,df$x)
...
# # print slope
# print(slope)
ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "solHCl.png", sep = ""), width = 10, height = 10)
# df <- na.omit(df)
...
# # print slope
# print(slope)
ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "solFeSSIF.png", sep = ""), width = 10, height = 10)
# df <- na.omit(df)
# print(paste(max(df),min(df)))
# 
# print(c(afe(df$x,df$y), aafe(df$x,df$y),slope))
...
# # print slope
# print(slope)
ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "solFaSSIF.png", sep = ""), width = 10, height = 10)
# df <- na.omit(df)
# print(paste(max(df),min(df)))
# 
# print(c(afe(df$x,df$y), aafe(df$x,df$y),slope))
...
# # print slope
# print(slope)
ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "solPBS.png", sep = ""), width = 10, height = 10)
# df <- na.omit(df)
# print(paste(max(df),min(df)))
# 
# print(c(afe(df$x,df$y), aafe(df$x,df$y),slope))
...
# # print slope
# print(slope)
ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "logD.png", sep = ""), width = 10, height = 10)
# df <- na.omit(df)
# print(paste(max(df),min(df)))
# 
# print(c(afe(df$x,df$y), aafe(df$x,df$y),slope))
...
# # print slope
# print(slope)
ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "fuhepAustin.png", sep = ""), width = 10, height = 10)
# df <- na.omit(df)
# print(paste(max(df),min(df)))
# 
# print(c(afe(df$x,df$y), aafe(df$x,df$y),slope))
...
# # print slope
# print(slope)
ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "fumic_half.png", sep = ""), width = 10, height = 10)
# df <- na.omit(df)
# print(paste(max(df),min(df)))
# 
# print(c(afe(df$x,df$y), aafe(df$x,df$y),slope))
...
# # print slope
# print(slope)
ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "rat_fup.png", sep = ""), width = 10, height = 10)
# df <- na.omit(df)
# print(paste(max(df),min(df)))
# 
# print(c(afe(df$x,df$y), aafe(df$x,df$y),slope))
...
# # print slope
# print(slope)
ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "RBP.png", sep = ""), width = 10, height = 10)
# df <- na.omit(df)
# print(paste(max(df),min(df)))
# 
# print(c(afe(df$x,df$y), aafe(df$x,df$y),slope))
...
# # print slope
# print(slope)
ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "CLintu_RLM.png", sep = ""), width = 10, height = 10)
# df <- na.omit(df)
# print(paste(max(df),min(df)))
# 
# print(c(afe(df$x,df$y), aafe(df$x,df$y),slope))
...
# # print slope
# print(slope)
ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "CLintu_RH.png", sep = ""), width = 10, height = 10)
# df <- na.omit(df)
# print(paste(max(df),min(df)))
# 
# print(c(afe(df$x,df$y), aafe(df$x,df$y),slope))
...
# print slope
# print(slope)
ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "CLintu_back_RH.png", sep = ""), width = 10, height = 10)
# df <- na.omit(df)
# print(paste(max(df),min(df)))
...
# # print slope
# print(slope)
ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "CLintu_back_RLM.png", sep = ""), width = 10, height = 10)
# print(paste(max(df),min(df)))
...
# print slope
# print(slope)
ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "CLint_obsu_RLM.png", sep = ""), width = 10, height = 10)
# df <- na.omit(df)
# print(paste(max(df),min(df)))
# 
...
# print slope
# print(slope)
ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "CLintu_obsu_RH.png", sep = ""), width = 10, height = 10)
# df <- na.omit(df)
# print(paste(max(df),min(df)))
# 
...
# print slope
# print(slope)
ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "Peff.png", sep = ""), width = 10, height = 10)
# df <- na.omit(df)
# print(paste(max(df),min(df))) 
