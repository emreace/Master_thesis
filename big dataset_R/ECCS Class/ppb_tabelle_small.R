...
fclb_low_to_moderate <- function(x,y){
  ...
  d3 <- as.numeric(data$PlasmaProteinBinding.Concentration..uM....1)>=2
...
fclb_low_to_moderate(x=which(colnames(data)=="KineticIV.Clearance..mL.min.kg."),y = which(colnames(data)=="CL_rat.Dose_mg"))
