...
for(i in 1:18){
  ...
  # print slope
  # print(slope)
  ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "Clearance_mL_min_kg.png", sep = ""), width = 10, height = 10)
  # df <- na.omit(df)
...
for(i in 1:18){
  ...
  # # print slope
  # print(slope)
  ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "KineticIV_AUC_ng_h_mL.png", sep = ""), width = 10, height = 10)
  # df <- na.omit(df)
  # print(paste(max(df),min(df)))
  # 
...
for(i in 1:18){
  ...
  # print slope
  # print(slope)
  ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "Vss.png", sep = ""), width = 10, height = 10)
  # df <- na.omit(df)
...
for(i in 1:18){
  ...
  # print slope
  # print(slope)
  ggsave(plot = plot_list, file = paste(names_vec[i],"ECCS", "Thalf.png", sep = ""), width = 10, height = 10)
  # df <- na.omit(df)
