...
# print slope
print(slope)
ggsave(plot = plot_list, file = paste(names_vec[i], "solHCl.png", sep = ""), width = 10, height = 10)
df <- na.omit(df)
print(paste(max(df),min(df)))

 z1 <- (c(afe(df$x,df$y), aafe(df$x,df$y),slope))
...
# 2
 ...
 # print slope
 print(slope)
 ggsave(plot = plot_list, file = paste(names_vec[i], "solFeSSIF.png", sep = ""), width = 10, height = 10)
 df <- na.omit(df)
 print(paste(max(df),min(df)))
 
 z2 <- (c(afe(df$x,df$y), aafe(df$x,df$y),slope))
 ...
 # print slope
 print(slope)
 ggsave(plot = plot_list, file = paste(names_vec[i], "solFaSSIF.png", sep = ""), width = 10, height = 10)
 df <- na.omit(df)
 print(paste(max(df),min(df)))
 
 z3 <- (c(afe(df$x,df$y), aafe(df$x,df$y),slope))
 # 4
 ...
 # print slope
 print(slope)
 ggsave(plot = plot_list, file = paste(names_vec[i], "solPBS.png", sep = ""), width = 10, height = 10)
 df <- na.omit(df)
 print(paste(max(df),min(df)))
 
 z4 <- (c(afe(df$x,df$y), aafe(df$x,df$y),slope))
 ...
 # print slope
 print(slope)
 ggsave(plot = plot_list, file = paste(names_vec[i], "logD.png", sep = ""), width = 10, height = 10)
 df <- na.omit(df)
 print(paste(max(df),min(df)))
 
 z5 <- (c(afe(df$x,df$y), aafe(df$x,df$y),slope))
 ...
 # print slope
 print(slope)
 ggsave(plot = plot_list, file = paste(names_vec[i], "fuhepAustin.png", sep = ""), width = 10, height = 10)
 df <- na.omit(df)
 print(paste(max(df),min(df)))
 
 z6 <- (c(afe(df$x,df$y), aafe(df$x,df$y),slope))
 ...
 # print slope
 print(slope)
 ggsave(plot = plot_list, file = paste(names_vec[i], "fumic_half.png", sep = ""), width = 10, height = 10)
 df <- na.omit(df)
 print(paste(max(df),min(df)))
 
 z7 <- (c(afe(df$x,df$y), aafe(df$x,df$y),slope))
 ...
 # print slope
 print(slope)
 ggsave(plot = plot_list, file = paste(names_vec[i], "rat_fup.png", sep = ""), width = 10, height = 10)
 df <- na.omit(df)
 print(paste(max(df),min(df)))
 
 z8 <- (c(afe(df$x,df$y), aafe(df$x,df$y),slope))
 ...
 # print slope
 print(slope)
 ggsave(plot = plot_list, file = paste(names_vec[i], "RBP.png", sep = ""), width = 10, height = 10)
 df <- na.omit(df)
 print(paste(max(df),min(df)))
 
 z9 <- (c(afe(df$x,df$y), aafe(df$x,df$y),slope))
 ...
 # print slope
 print(slope)
 ggsave(plot = plot_list, file = paste(names_vec[i], "CLintu_RLM.png", sep = ""), width = 10, height = 10)
 df <- na.omit(df)
 print(paste(max(df),min(df)))
 
 z10 <- (c(afe(df$x,df$y), aafe(df$x,df$y),slope))
 # 11
 ...
 plot_list <- ggplot(data = df, mapping = aes(x = df$x,y = df$y))+
   geom_point(mapping = aes(y=df$y,x=df$x), colour = "#529EFF")+
   scale_x_log10(limits = c(6,30000), labels = comma)+
   scale_y_log10(limits = c(6,30000), labels = comma)+
   geom_abline(intercept = 0, slope = 1)+
   stat_function(mapping = aes(),fun = stat_function_01,geom = "line",inherit.aes = T, linetype = "dashed")+
   stat_function(mapping = aes(),fun = stat_function_02,geom = "line",inherit.aes = T, linetype = "dashed")+
   stat_function(mapping = aes(),fun = stat_function_03,geom = "line",inherit.aes = T, linetype = "dotted")+
 ...
 # print slope
 print(slope)
 ggsave(plot = plot_list, file = paste(names_vec[i], "CLintu_RH.png", sep = ""), width = 10, height = 10)
 df <- na.omit(df)
 print(paste(max(df),min(df)))
 
 z11 <- (c(afe(df$x,df$y), aafe(df$x,df$y),slope))
 ...
 x <- as.numeric(tem$MetStabRatHepSusp.intrClearance..ul..min.1E6.cells..)*3.89/(as.numeric(tem$Hepatocyte.binding.fu.hep....)/100)
y <- as.numeric(d$Clintu_obs_backcalc)
 ...
 plot_list <- ggplot(data = df, mapping = aes(x = df$x,y = df$y))+
   geom_point(mapping = aes(y=df$y,x=df$x), colour = "#529EFF")+
   scale_x_log10(limits = c(as.numeric(1),200000), labels = comma)+
   scale_y_log10(limits = c(as.numeric(1),200000), labels = comma)+
   geom_abline(intercept = 0, slope = 1)+
   stat_function(mapping = aes(),fun = stat_function_01,geom = "line",inherit.aes = T, linetype = "dashed")+
   stat_function(mapping = aes(),fun = stat_function_02,geom = "line",inherit.aes = T, linetype = "dashed")+
   stat_function(mapping = aes(),fun = stat_function_03,geom = "line",inherit.aes = T, linetype = "dotted")+
 ...
 ggsave(plot = plot_list, file = paste(names_vec[i], "CLintu_back_RH.png", sep = ""), width = 10, height = 10)
 df <- na.omit(df)
 print(paste(max(df),min(df)))
 ...
 x <- as.numeric(tem$MetStabRatMicros.intrClearance..ul..min.mg..)*1.66/(as.numeric(tem$Microsomal.binding.fu.mic....)/100)
 y <- as.numeric(d$Clintu_obs_backcalc)
...
slope <- summary(model)$coefficients[2]
 ...
 # print slope
 print(slope)
 ggsave(plot = plot_list, file = paste(names_vec[i], "CLintu_back_RLM.png", sep = ""), width = 10, height = 10)
 print(paste(max(df),min(df)))
 ...
 # print slope
 print(slope)
 ggsave(plot = plot_list, file = paste(names_vec[i], "CLint_obsu_RLM.png", sep = ""), width = 10, height = 10)
 df <- na.omit(df)
 print(paste(max(df),min(df)))
 ...
 # print slope
 print(slope)
 ggsave(plot = plot_list, file = paste(names_vec[i], "CLintu_obsu_RH.png", sep = ""), width = 10, height = 10)
 df <- na.omit(df)
 print(paste(max(df),min(df)))
 ...
 # print slope
 print(slope)
 ggsave(plot = plot_list, file = paste(names_vec[i], "Peff.png", sep = ""), width = 10, height = 10)
 df <- na.omit(df)
 print(paste(max(df),min(df))) 
