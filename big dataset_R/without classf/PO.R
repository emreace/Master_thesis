...
plot_list <- list()
sim_po_F <- matrix(data = NA, nrow = 6, ncol = 3, byrow = FALSE, dimnames = NULL)
for(i in 1:6){
  d <- dl[[i]]
...
# Create empty list to store plots
plot_list <- list()
sim_po_auc <- matrix(data = NA, nrow = 6, ncol = 3, byrow = FALSE, dimnames = NULL)
for(i in 1:6){
  d <- dl[[i]]
...
# Create empty list to store plots
plot_list <- list()
sim_mat_cmax <- matrix(data = NA, nrow = 6, ncol = 3, byrow = FALSE, dimnames = NULL)
for(i in 1:6){
  d <- dl[[i]]
...
# Create empty list to store plots
plot_list <- list()
sim_mat_t_max <- matrix(data = NA, nrow = 6, ncol = 3, byrow = FALSE, dimnames = NULL)
for(i in 1:6){
  d <- dl[[i]]
