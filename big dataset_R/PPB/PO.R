...
for(i in 1:6){
  ...
  # # print slope
  # print(slope)
  ggsave(plot = plot_list, file = paste(names_vec[i],"PPB", "po_F.png", sep = ""), width = 10, height = 10)
  # df <- na.omit(df)
...
for(i in 1:6){
  ...
  # # print slope
  # print(slope)
  ggsave(plot = plot_list, file = paste(names_vec[i],"PPB", "po_auc.png", sep = ""), width = 10, height = 10)
  # df <- na.omit(df)
  # print(paste(max(df),min(df)))
...
for(i in 1:6){
  ...
  # # print slope
  # print(slope)
  ggsave(plot = plot_list, file = paste(names_vec[i],"PPB", "cmax.png", sep = ""), width = 10, height = 10)
  # df <- na.omit(df)
...
for(i in 1:6){
  ...
  # print slope
  # print(slope)
  ggsave(plot = plot_list, file = paste(names_vec[i],"PPB", "Tmax.png", sep = ""), width = 10, height = 10)
  # df <- na.omit(df)
