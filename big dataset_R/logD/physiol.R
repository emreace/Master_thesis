...
admed_physiol <- arrange(admed_physiol,admed_physiol$Idorsia.No)
logD <- admed_physiol$S.logD
...
df <- data.frame(x,y,logD)
df$logD <- ifelse(df$logD=="",NA,df$logD)
df$y <- ifelse(df$y==0,NA,df$y)
df$x <- ifelse(df$x==0,NA,df$x)
df$logD <- ifelse(df$logD>0,df$logD,NA)
...
plot_list <- ggplot(data = df, mapping = aes(x = df$x,y = df$y))+
  ...
  geom_point(aes(colour=logD, group=logD))+
  theme_classic()+
  labs(
    title = paste("solHCl"),
    subtitle = "",
...
# 2
 ...
 # # print slope
 # print(slope)
 ggsave(plot = plot_list, file = paste( "fuhepAustin.png", sep = ""), width = 10, height = 10)
 # df <- na.omit(df)
 # print(paste(max(df),min(df)))
 # 
 # print(c(afe(df$x,df$y), aafe(df$x,df$y),slope))
 ...
 # # print slope
 # print(slope)
 ggsave(plot = plot_list, file = paste( "fumic_half.png", sep = ""), width = 10, height = 10)
 # df <- na.omit(df)
 # print(paste(max(df),min(df)))
 # 
 # print(c(afe(df$x,df$y), aafe(df$x,df$y),slope))
 ...
 # # print slope
 # print(slope)
 ggsave(plot = plot_list, file = paste( "rat_fup.png", sep = ""), width = 10, height = 10)
 # df <- na.omit(df)
 # print(paste(max(df),min(df)))
 # 
 # print(c(afe(df$x,df$y), aafe(df$x,df$y),slope))
 ...
 # # print slope
 # print(slope)
 ggsave(plot = plot_list, file = paste( "RBP.png", sep = ""), width = 10, height = 10)
 # df <- na.omit(df)
 # print(paste(max(df),min(df)))
 # 
 # print(c(afe(df$x,df$y), aafe(df$x,df$y),slope))
