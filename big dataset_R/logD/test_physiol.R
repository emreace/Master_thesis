...
y <- as.numeric(d$CYP_RLM_CLint)*1.66/0.25
...
y <- as.numeric(d$HEP_rCLint)*3.89/0.25
...
x <- as.numeric(template$MetStabRatMicros.intrClearance..ul..min.mg..)*1.66/(as.numeric(template$Microsomal.binding.fu.mic....)/100)
y <- (1.66 * ((as.numeric(d$CYP_RLM_CLint))*template$fumic_half_mg_ml_conc)/(as.numeric(template$Microsomal.binding.fu.mic....)/100))/0.25
...
x <- as.numeric(template$MetStabRatHepSusp.intrClearance..ul..min.1E6.cells..)*3.89/(as.numeric(template$Hepatocyte.binding.fu.hep....)/100)
y <- (3.89 * ((as.numeric(template$HEP_rCLint))*template$fu.hep.Austin)/(as.numeric(template$Hepatocyte.binding.fu.hep....)/100))/0.25
