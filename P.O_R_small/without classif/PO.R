...
P.O.1 <- read.csv("~/Rat p.o/definitive sim/P.O.1/P.O.1.csv")
P.O.2 <- read.csv("~/Rat p.o/definitive sim/P.O.2/P.O.2.csv")
P.O.3 <- read.csv("~/Rat p.o/definitive sim/P.O.3/P.O.3.csv")
P.O.4 <- read.csv("~/Rat p.o/definitive sim/P.O.4/P.O.4.csv")
# setwd("~/Big Dataset/Simulations/fed properties fup,RBP,logD")

template <- read.csv("~/Rat p.o/definitive sim/template.csv")
library(dplyr)
