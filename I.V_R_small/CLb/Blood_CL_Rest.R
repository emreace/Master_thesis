...
Syst.in.vivo.CLbb<-ERA_Rat_iv_PK_properties_reconstructed_v9_geomeans_cleaned_multiple_values_MDR1_pKa_merged_CLpmicros_CLphep_dosemg_ADMET7.4_PKSIM_RH$KineticIV.Clearance..mL.min.kg.

classification <- c()
for(i in 1:length(Syst.in.vivo.CLbb)){if(Syst.in.vivo.CLbb[i]==0){
  classification[i] <- "NA"}else{
    if(Syst.in.vivo.CLbb[i]<=36.6){
      classification[i] <- "low"  
    }else{
      if(Syst.in.vivo.CLbb[i]>36.6&Syst.in.vivo.CLbb[i]<85.4){
        classification[i] <- "moderate"
      }else{
        if(Syst.in.vivo.CLbb[i]>=85.4){
          classification[i] <- "high"
        }
      }
    }
...
Syst.in.vivo.CLbb<-ERA_Rat_iv_PK_properties_reconstructed_v9_geomeans_cleaned_multiple_values_MDR1_pKa_merged_CLpmicros_CLphep_dosemg_ADMET7.4_PKSIM_RLM$KineticIV.Clearance..mL.min.kg.
classification <- c()
for(i in 1:length(Syst.in.vivo.CLbb)){if(Syst.in.vivo.CLbb[i]==0){
  classification[i] <- "NA"}else{
    if(Syst.in.vivo.CLbb[i]<=36.6){
...
y <- ERA_Rat_iv_PK_properties_reconstructed_v9_geomeans_cleaned_multiple_values_MDR1_pKa_merged_CLpmicros_CLphep_dosemg_ADMET7.4_PKSIM_RLM$AUCinf_rat.Dose_mg
fm <- lm(log10(y)~log10(x))
ff <- summary(fm)
...
y <- ERA_Rat_iv_PK_properties_reconstructed_v9_geomeans_cleaned_multiple_values_MDR1_pKa_merged_CLpmicros_CLphep_dosemg_ADMET7.4_PKSIM_RH$AUCinf_rat.Dose_mg
fm <- lm(log10(y)~log10(x))
ff <- summary(fm)
...
Syst.in.vivo.CLbb<-ERA_Rat_iv_PK_properties_reconstructed_v9_geomeans_cleaned_multiple_values_MDR1_pKa_merged_CLpmicros_CLphep_dosemg_ADMET7.4$KineticIV.Clearance..mL.min.kg.
...
Syst.in.vivo.CLbb<-ADMET7.4$KineticIV.Clearance..mL.min.kg.
...
Syst.in.vivo.CLbb<-only_fup_input_RLM$CL_Blood
...
Syst.in.vivo.CLbb<-only_RBP_input_RLM$CL_Blood
...
Syst.in.vivo.CLbb<-ADMET7.4$CL_b
