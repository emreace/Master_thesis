...
Ionization_Class_Code<-ERA_Rat_iv_PK_properties_reconstructed_v9_geomeans_cleaned_multiple_values_MDR1_pKa_merged_CLpmicros_CLphep_dosemg_ADMET7.4_PKSIM_RH$Ionization_class_Code
...
CLphep1vsKineticIV.Clearance..mL.min.kg._MFE <- ggplot(data = ERA_Rat_iv_PK_properties_reconstructed_v9_geomeans_cleaned_multiple_values_MDR1_pKa_merged_CLpmicros_CLphep_dosemg_ADMET7.4_PKSIM_RH, mapping = aes(x = x,y = y))+
  ...
  geom_point(aes(colour=Ionization_Class_Code, group=Ionization_Class_Code))+
...
ggsave(plot = CLphep1vsKineticIV.Clearance..mL.min.kg._no_MFE, file = "CLphep1vsKineticIV.Clearance..mL.min.kg._no_MFE.png")
...
ggsave(plot = CLp.micros1vsKineticIV.Clearance..mL.min.kg._no_MFE, file = "CLp.micros1vsKineticIV.Clearance..mL.min.kg._no_MFE.png")
...
Ionization_Class_Code<-ERA_Rat_iv_PK_properties_reconstructed_v9_geomeans_cleaned_multiple_values_MDR1_pKa_merged_CLpmicros_CLphep_dosemg_ADMET7.4_PKSIM_RLM$Ionization_class_Code
...
ggsave(plot = pred_AUCinf_ratvsAUC_obs, file = "pred_AUCinf_ratvsAUC_obs_ionization.png")
...
pred_AUCinf_ratvsAUC_obs
ggsave(plot = pred_AUCinf_ratvsAUC_obs, file = "AUC_RLM_ioniz.png", width = 10, height = 10)
...
ggsave(plot = THalf_rat.Dose_mg_hepvsKineticIV.Thalf..h., file = "THalf_rat.Dose_mg_hepvsKineticIV.Thalf..h..png")
...
THalf_rat.Dose_mgvsKineticIV.Thalf..h._RLM <- ggplot(data = ERA_Rat_iv_PK_properties_reconstructed_v9_geomeans_cleaned_multiple_values_MDR1_pKa_merged_CLpmicros_CLphep_dosemg_ADMET7.4_PKSIM_RLM, mapping = aes(x = x,y = y))+
  ...
  theme_classic()+
  labs(
    title = "THalf_rat.Dose_mg vs KineticIV.Thalf..h._RLM",
    subtitle = "",
    x = "KineticIV.Thalf..h. (h)",
    y = "THalf_rat.Dose_mg (h)")
...
Ionization_Class_Code<-ERA_Rat_iv_PK_properties_reconstructed_v9_geomeans_cleaned_multiple_values_MDR1_pKa_merged_CLpmicros_CLphep_dosemg_ADMET7.4$Ionization_class_Code
...
Ionization_Class_Code<-ADMET7.4$Ionization_class_Code
...
Ionization_Class_Code<-ADMETpH1_2_export$Ionization_class_Code

x <- ADMETpH1_2_export$solHCLsolubility.mg.mL.
y <- ADMETpH1_2_export$S.S_pH
fm <- lm(log10(y)~log10(x))
ff <- summary(fm)

solHCLsolubility.mg.mL.vsS.S_pH <- ggplot(data = ADMETpH1_2_export, mapping = aes(x = x,y = y))+
  geom_point(mapping = aes(y=ADMETpH1_2_export$S.S_pH,x=ADMETpH1_2_export$solHCLsolubility.mg.mL.), colour = "#529EFF")+
  ...
  labs(
    ...
    subtitle = "",
    x = "HCl_solubility (mg/mL)",
    y = "pred_HCl_solubility (mg/mL)")
...
Ionization_Class_Code<-IVIVE2$Ionization_class_Code
...
Ionization_Class_Code<-IVIVE2_hep$Ionization_class_Code
...
Ionization_Class_Code<-IVIVE3$Ionization_class_Code
...
Ionization_Class_Code<-IVIVE3_hep$Ionization_class_Code
...
Ionization_Class_Code<-optim_RLM_ion_class$Ionization_class_Code
...
Ionization_Class_Code<-only_fup_input_RLM_ion_class$Ionization_class_Code
...
Ionization_Class_Code<-only_RBP_input_RLM_ion_class$Ionization_class_Code
...
Ionization_Class_Code<-only_fup_input_RLM_chem_class$Ionization_class_Code
...
Vss_logD_fup_BP
ggsave(plot = Vss_logD_fup_BP, file = "Vss_logD_fup_BP_ion.png", width = 10, height = 10)
...
ggsave(plot = CLintuvspred_CL_intu_RLM, file = "CLintuvspred_CL_intu_RLM_ion.png", width = 10, height = 10)
...
ggsave(plot = CLintuvspred_CL_intu_H, file = "CLintuvspred_CL_intu_H_ion.png", width = 10, height = 10)
...
ggsave(plot = CLintuvspred_CL_intu_obsu_RLM, file = "CLintuvspred_CL_intu_obsu_RLM_ion.png", width = 10, height = 10)
...
ggsave(plot = CLintuvspred_CL_intu_obsu_hep, file = "CLintuvspred_CL_intu_obsu_hep_ion.png", width = 10, height = 10)
